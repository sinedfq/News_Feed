...
1. При переходе по ссылке вы попадаете на главную страницу, где отображаются все созданные новости
<img width="1919" height="917" alt="image" src="https://github.com/user-attachments/assets/24583166-81a3-4321-af7f-431912142286" />

*некоторые картинки не отображаются поскольку они удалены

2. Чтобы создать новую новость необходимо кликнуть на кнопку "Добавить новость в верхнем левом углу экрана". после клика вы попадаете на страницу заполнения формы новости, где необходимо указать Заголовок новости, описание и выбор фотографии
<img width="1919" height="927" alt="image" src="https://github.com/user-attachments/assets/29b4c071-b0ad-450a-ae57-34ee30dc05bc" />

3. В случае если новостей больше чем выбрано в правом верхнем углу, то внизу страницы появляется меню с переключением страниц
